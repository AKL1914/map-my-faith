    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body">
                ...
                <!-- Show form only if area or group is null or empty -->
                <div v-if="!user?.area || !user?.group" class="form-section">
                    ...
                    <button @click="saveProfile" class="btn btn-primary btn-block" :disabled="loading">
                        {{ loading ? 'Saving...' : 'Save' }}
                    </button>
