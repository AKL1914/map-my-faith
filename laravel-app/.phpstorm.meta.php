...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.game_pin_distance' => 'integer',
            'app.los_email' => 'string',
            'app.area_groups.1' => 'array',
            'app.area_groups.2' => 'array',
            'app.area_groups.3' => 'array',
            'app.area_groups.4' => 'array',
            'app.area_groups.5' => 'array',
            'app.area_groups.6' => 'array',
            ...
            'database.redis.session.prefix' => 'string',
...
'app.aliases.Vite','app.admin_email','app.admin_name','app.game_pin_distance','app.los_email',
'app.area_groups.1','app.area_groups.2','app.area_groups.3','app.area_groups.4','app.area_groups.5',
'app.area_groups.6','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'database.redis.session.url','database.redis.session.host','database.redis.session.username','database.redis.session.password','database.redis.session.port',
'database.redis.session.database','database.redis.session.prefix','database.redis.horizon.url','database.redis.horizon.host','database.redis.horizon.username',
...
'webpush.vapid.subject','webpush.vapid.public_key','webpush.vapid.private_key','webpush.vapid.pem_file','webpush.model',
'webpush.table_name','webpush.database_connection','webpush.client_options','webpush.automatic_padding','hashing.driver',
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','login.google',
'logout','login','home','maps.index',
'profile.edit','profile.update','profile.pins','campaigns.index','campaigns.store',
'campaigns.show','campaigns.update','campaigns.destroy',
'admin.campaigns.index','admin.users.index','admin.pins.index','show','admin.dashboard.report','activate','admin.login','storage.local',);
        registerArgumentsSet('views', 
'activate.index','admin.campaigns.index','admin.dashboard','admin.foyer','admin.gamification.events.index',
'admin.gamification.events.participants','admin.gamification.events.show','admin.gamification.gamepins.index','admin.leaderboard.index','admin.settings.index',
'admin.users.index','auth.admin-login','emails.pin_report','emails.user_activated_plain','layouts.app',
'layouts.theme.app','maps.index','partials.footer','partials.navigation','partials.public.navigation',
'partials.theme.footer','partials.theme.navigation','partials.theme.top_navigation','pins.index','pins.show',
'profile.edit','profile.pins','welcome','horizon::layout','laravel-exceptions-renderer::components.card',
...
'DB_PASSWORD','SESSION_DRIVER','SESSION_CONNECTION','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','SESSION_PREFIX','MEMCACHED_HOST','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GOOGLE_REDIRECT_URI','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
'PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','CACHE_PREFIX','CACHE_STORE','REDIS_CACHE_CONNECTION','CACHE_DRIVER',
'QUEUE_CONNECTION','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'REDIS_DB','REDIS_CACHE_DB','REDIS_SESSION_DB','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ADMIN_NAME1',
'ADMIN_EMAIL1','ADMIN_PASSWORD1','ADMIN_NAME2','ADMIN_EMAIL2','ADMIN_PASSWORD2',
'ADMIN_NAME3','ADMIN_EMAIL3','ADMIN_PASSWORD3','ADMIN_NAME4','ADMIN_EMAIL4',
'ADMIN_PASSWORD4','ADMIN_NAME5','ADMIN_EMAIL5','ADMIN_PASSWORD5','VAPID_PUBLIC_KEY',
'VAPID_PRIVATE_KEY','BROADCAST_DRIVER','LOS_EMAIL',);
